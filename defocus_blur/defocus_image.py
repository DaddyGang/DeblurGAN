...
class DefocusBlurImage(object):
    ...
    # def blur_image(self, rgb, depth, focalDepth):
    #     """
    #     :param rgb: [x, y, RGB]
    #     :param depth: [x, y, depth]
    #     :param focalDepth: Focal plane depth
    #     :param path__to_save: folder to save results.
    #
    ...
    #             distanceFromFocalPlane = abs(depth[x, y] - focalDepth)
    #             kernel = cv2.getGaussianKernel(3, distanceFromFocalPlane)
    #
...
if __name__ == '__main__':
    ...
    for path in os.listdir(folder):
        ...
        DefocusBlurImage(os.path.join(folder, path), PSFs=psf,
